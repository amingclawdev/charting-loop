        ...
        *,
        ...
        program = "\n".join(
            [
                ...
                "from corridor_kit.core import MAX_RULE_CANDIDATE_DECODE_BYTES,atomic_write_bytes",
                ...
                "assembled=assemble_parallel_rule_ir(load_json(partition_path,max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES),load_json(rule_path,max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES),load_json(witness_path,max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES))",
        ...
        *,
        ...
        program = "\n".join(
            [
                ...
                "from corridor_kit.core import MAX_RULE_CANDIDATE_DECODE_BYTES",
                "from corridor_kit.graph_index import compile_repairs_are_disjoint",
                f"report=load_json(Path({compile_report_path!r}),max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES)",
        ...
        *,
        ...
        program = "\n".join(
            [
                ...
                "from corridor_kit.core import MAX_RULE_CANDIDATE_DECODE_BYTES,atomic_write_bytes",
                f"partition=load_json(Path({source_partition_path!r}),max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES)",
                f"prior=load_json(Path({prior_witness_product_path!r}),max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES)",
        ...
        *,
        ...
        build_program = "\n".join(
            [
                "import json",
                "from pathlib import Path",
                "from corridor_kit import CorridorKitError,canonical_json_bytes,load_json,sha256_bytes,sha256_json",
                "from corridor_kit.core import MAX_RULE_CANDIDATE_DECODE_BYTES",
                "from corridor_kit.graph import freeze_rule_candidate,read_rule_candidate_payload",
                f"p=Path({graph_path!r})",
                f"ir=load_json(Path({ir_path!r}),max_bytes=MAX_RULE_CANDIDATE_DECODE_BYTES)",
